...
Goal.create(user_id: 1, name: "Meditate", description: "Meditate every morning", frequency: 5, binary: TRUE)
  Log.create(goal_id: 1, date: Date.today-3, binary_input: TRUE)
  Log.create(goal_id: 1, date: Date.today-2, binary_input: TRUE)
  Log.create(goal_id: 1, date: Date.today-1, binary_input: FALSE)
...
Goal.create(user_id: 1, name: "Water Intake", description: "Drink 90oz of water daily", frequency: 7, binary: FALSE, amount: 90, unit: "oz")
  Log.create(goal_id: 2, date: Date.today-3, amount_input: 90)
  Log.create(goal_id: 2, date: Date.today-1, amount_input: 50)
  Log.create(goal_id: 2, date: Date.today, amount_input: 60)
